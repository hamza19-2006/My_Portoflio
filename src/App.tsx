        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-8 mb-20">
            ...
            <motion.a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 px-10 py-5 rounded-full bg-[#242429] border border-white/10 text-white hover:bg-[#2d2d33] transition-all shadow-xl group"
            >
            ...
            <motion.a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 px-10 py-5 rounded-full bg-gradient-to-br from-[#0f1f14] to-[#142318] border border-[#25D366]/20 text-white shadow-[0_0_40px_rgba(37,211,102,0.1)] hover:border-[#25D366]/40 transition-all group"
            >
              <svg className="w-7 h-7 text-[#25D366] group-hover:text-[#1FAF53] transition-colors" viewBox="0 0 24 24" fill="currentColor">
